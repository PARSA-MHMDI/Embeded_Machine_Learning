/**
  ...
  ******************************************************************************
  */
#ifndef AI_CONSUMPTION_MODEL_H
#define AI_CONSUMPTION_MODEL_H

#include "consumption_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CONSUMPTION_MODEL_MODEL_NAME          "consumption_model"
#define AI_CONSUMPTION_MODEL_ORIGIN_MODEL_NAME   "consumption_model"

/******************************************************************************/
#define AI_CONSUMPTION_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CONSUMPTION_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CONSUMPTION_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CONSUMPTION_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_CONSUMPTION_MODEL_IN \
  ai_consumption_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CONSUMPTION_MODEL_IN_SIZE { \
  AI_CONSUMPTION_MODEL_IN_1_SIZE, \
}
#define AI_CONSUMPTION_MODEL_IN_SIZE_BYTES { \
  AI_CONSUMPTION_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_CONSUMPTION_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CONSUMPTION_MODEL_IN_1_HEIGHT      (100)
#define AI_CONSUMPTION_MODEL_IN_1_CHANNEL     (1)
#define AI_CONSUMPTION_MODEL_IN_1_SIZE        (100)
#define AI_CONSUMPTION_MODEL_IN_1_SIZE_BYTES  (400)

/******************************************************************************/
#define AI_CONSUMPTION_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CONSUMPTION_MODEL_OUT \
  ai_consumption_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CONSUMPTION_MODEL_OUT_SIZE { \
  AI_CONSUMPTION_MODEL_OUT_1_SIZE, \
}
#define AI_CONSUMPTION_MODEL_OUT_SIZE_BYTES { \
  AI_CONSUMPTION_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_CONSUMPTION_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CONSUMPTION_MODEL_OUT_1_CHANNEL     (1)
#define AI_CONSUMPTION_MODEL_OUT_1_SIZE        (1)
#define AI_CONSUMPTION_MODEL_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CONSUMPTION_MODEL_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup consumption_model
 ...
 * @ref ai_consumption_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_consumption_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_consumption_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_consumption_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CONSUMPTION_MODEL_*
 * defines into file @ref consumption_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_consumption_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CONSUMPTION_MODEL_H */
